...
class RegexUtil {
  ...
  /// Regex of ip pwd.
  static final String regexPwd = "[A-Za-z0-9]+";

  ///特殊字符
  static final String regexSafety = r"^[\u4E00-\u9FA5A-Za-z0-9_,-!?，？丶]+$";
  ...
  /// Return whether input matches regex of ip address.
  static bool isSafety(String input) {
    return RegExp(regexSafety).firstMatch(input) != null;
  }

        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 25),
//        验证码.svg
              LoginInputItem('手机号', '请输入手机号', phone,
                  inputFormatters: [LengthLimitingTextInputFormatter(11), OnlyInputNumberAndWorkFormatter()],
                keyboardType: TextInputType.phone,
              ),
              SizedBox(height: 25),
              LoginInputItem('验证码', '请输入验证码', verifyCode,
                  actions: [SMSCodeView(phone.text, SMSType.register)],
                  inputFormatters: [LengthLimitingTextInputFormatter(5), OnlyInputNumberAndWorkFormatter()],
              ...
              Row(
                ...
                onTap: () => simpleSub(OAuthCtrl.obj.doPwdLogin('13600000001', '123456')),
              ),
            ],
          ),
        ),

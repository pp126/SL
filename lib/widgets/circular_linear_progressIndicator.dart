...
class _LinearProgressIndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawBar(double x, double width) {
      ...
      canvas.drawCircle(Offset(width - 5, size.height / 2), 5, paint);
      canvas.drawRect(Offset(left, 0.0) & Size(width - 5, size.height), paint);
    }
...
class CircularLinearProgressIndicator extends ProgressIndicator {
  /// Creates a linear progress indicator.
  ///
  /// {@macro flutter.material.progressIndicator.parameters}
  const CircularLinearProgressIndicator({
    Key key,
    double value,
    Color backgroundColor,
...
class _LinearProgressIndicatorState
    extends State<CircularLinearProgressIndicator>
  ...
  @override
  void didUpdateWidget(CircularLinearProgressIndicator oldWidget) {

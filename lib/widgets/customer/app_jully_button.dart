      ...
      child: Container(
        ...
        child: AnimatedBuilder(
            ...
            builder: (context, child) {
              double moveSize = 10;
              String image = widget.checked ? widget.checkedImgAsset : widget.unCheckedImgAsset;
              double width = (widget.size.width - widget.padding.horizontal) - moveSize*_animation.value;
              double height = (widget.size.height - widget.padding.vertical) - moveSize*_animation.value;
              return widget.checkedImgAsset.contains('.svg')?SvgPicture.asset(
                  image,
                  width: width,
